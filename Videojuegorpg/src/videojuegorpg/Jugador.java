 ...
 */
public class Jugador implements Serializable, HUD{
    ...
    public void mostrarClases() {
        if (clases.equals("Mago")) {
            System.out.println("                                  ....\n"
                    ...
                    + "                 '._____|'.\\\\......'''''''.:..'''\n"
                    + "                            \\\\");
        } else if (clases.equals("Guerrero")) {
